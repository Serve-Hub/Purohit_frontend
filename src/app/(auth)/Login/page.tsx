...
async function handleSubmit(event) {
  ...
  return (
    <div>
        <div className="flex flex-col items-center justify-center min-h-screen bg-white md:flex-row bg-[url('/img/bg.png')] bg-cover bg-center">
      <div className="flex flex-col items-center justify-center md:w-1/2 lg:w-1/2 h-[100vh] rounded-3xl ">
