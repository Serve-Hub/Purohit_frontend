      ...
      <div className="relative z-20 bg-white dark:bg-form-input">
        ...
        <select
         name={name} 
          ...
          //   changeTextColor();
          // }}
          className={`relative z-20 w-full appearance-none rounded border border-stroke bg-transparent px-12 py-3 outline-none transition focus:border-pg active:border-pg dark:border-form-strokedark dark:bg-form-input ${
