                                                      ...
                                                      >
                                                        ...
                                                        <div className="flex flex-col space-y-4">
                                                          ...
                                                          <div className="flex justify-end">
                                                            <img
                                                            src={a.panditKYP.panditID.avatar}
                                                          ...
                                                          <div className="flex justify-between items-center">
                                                              ...
                                                              <div>
                                                                ...
                                                                <span className="ms-3">
                                                                {a.panditKYP.panditID.lastName}                                                                </span>
                                                            </div>
                                                          ...
                                                          <div className="flex justify-between">
                                                            ...
                                                            <span>
                                                            {a.panditKYP.permanentAddress.tolAddress},                                                                                                                       
                                                            {a.panditKYP.permanentAddress.municipality},                                                                                                                              
                                                            {a.panditKYP.permanentAddress.district},                                                                                                                             
                                                            {a.panditKYP.permanentAddress.province},                                                                                                                             
                                                          ...
                                                          <div className="flex justify-between">
                                                            ...
                                                            {a.panditKYP.temporaryAddress.tolAddress},                                                                                                                       
                                                            {a.panditKYP.temporaryAddress.municipality},                                                                                                                              
                                                            {a.panditKYP.temporaryAddress.district},                                                                                                                             
                                                            {a.panditKYP.temporaryAddress.province},  
                                                          ...
                                                          <div className="flex justify-between">
                                                            ...
                                                            <span>
                                                            {a.panditKYP.dateOfBirth.day}-   {a.panditKYP.dateOfBirth.month}- {a.panditKYP.dateOfBirth.year}
                                                        ...
                                                        <div className="flex flex-col space-y-4 mt-8">
                                                          ...
                                                          <div className="flex justify-between">
                                                            ...
                                                            <span>Rs  {booking.pujaID.baseFare}</span>
                                                          </div>
                                                          <div className="flex justify-between">
